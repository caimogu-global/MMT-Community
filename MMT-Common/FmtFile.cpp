...
FmtFile::FmtFile(std::wstring fmtFilePath) {
	...
	//但是这个分类很明显是错误的，从fmt文件中读取出来是无法赋予Category信息的。
	//TODO 这个后续改为可选项或者直接去掉，暂时不管。
