...
void Functions_GI::GenerateMod() {
            ...
            for (const auto& DrawIBPair : G.DrawIB_ExtractConfig_Map) {
                ...
                for (const auto& TexturePair : Hash_TextureFileNameMap) {
                    ...
                    if (std::filesystem::exists(FilePath)) {
                        ...
                        GIIniBuilder.AppendSection(ResourceSection);
                        ...
                        GIIniBuilder.AppendSection(TextureOverrideSection);
    ...
    GIIniBuilder.SaveToFile(G.TimeOutputFolder + L"Config.ini");
